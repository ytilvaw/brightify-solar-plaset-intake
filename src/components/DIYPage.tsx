...
const KITS: Kit[] = [
  ...
  {
    id: 'ecoflow-5kw-delta-pro-ultra-6kwh',
    name: '5kW EcoFlow Delta Pro Ultra DIY Kit',
    tagline: 'EcoFlow Delta Pro Ultra · 5kW Solar · 6kWh Battery',
    type: 'battery-backup',
    solarKw: 5,
    batteryKwh: 6,
    components: [
      ...
      '6kWh EcoFlow Power Station Battery',
    ],
    price: 5960,
    image: '/kits/kit-ecoflow-5kw-delta-pro-ultra.jpg',
    tags: ['battery-backup', 'ecoflow'],
  },
  {
    id: 'ecoflow-6kw-delta-pro-ultra-x-12kwh',
    name: '6kW EcoFlow Delta Pro Ultra X DIY Kit',
    tagline: 'EcoFlow Delta Pro Ultra X · 6kW Solar · 12kWh Battery',
    type: 'battery-backup',
    solarKw: 6,
    batteryKwh: 12,
    components: [
      '6kW solar panels',
      'EcoFlow Delta Pro Ultra X Inverter',
      '12kWh EcoFlow Power Station Battery (2×)',
    ],
    price: 10300,
    image: '/kits/kit-ecoflow-6kw-delta-pro-ultra-x.jpg',
    tags: ['battery-backup', 'ecoflow'],
  },
  {
    id: 'ecoflow-8kw-delta-pro-ultra-x-18kwh',
    name: '8kW EcoFlow Delta Pro Ultra X DIY Kit',
    tagline: 'EcoFlow Delta Pro Ultra X · 8kW Solar · 18kWh Battery',
    type: 'battery-backup',
    solarKw: 8,
    batteryKwh: 18,
    components: [
      '8kW solar panels',
      'EcoFlow Delta Pro Ultra X Inverter',
      '18kWh EcoFlow Power Station Battery (3×)',
    ],
    price: 13200,
    image: '/kits/kit-ecoflow-8kw-delta-pro-ultra-x.jpg',
    tags: ['battery-backup', 'ecoflow'],
  },
  {
    id: 'ecoflow-10kw-delta-pro-ultra-x-24kwh',
    name: '10kW EcoFlow Delta Pro Ultra X DIY Kit',
    tagline: 'EcoFlow Delta Pro Ultra X · 10kW Solar · 24kWh Battery',
    type: 'battery-backup',
    solarKw: 10,
    batteryKwh: 24,
    components: [
      '10kW solar panels',
      'EcoFlow Delta Pro Ultra X Inverter',
      '24kWh EcoFlow Power Station Battery (4×)',
    ],
    price: 16200,
    image: '/kits/kit-ecoflow-10kw-delta-pro-ultra-x.jpg',
    tags: ['battery-backup', 'ecoflow'],
    flag: 'Most powerful',
  },
];
