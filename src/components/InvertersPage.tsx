...
const INVERTERS: Inverter[] = [
  ...
  },
  {
    ...
    warranty: '5 yr',
    price: 2090,
    image: '/inverters/eg4-12000xp.jpg',
    tags: ['offgrid', 'eg4', 'split-phase'],
    datasheet: '/datasheets/eg4-12000xp.pdf',
    certifications: 'UL9540, NEC 690.12',
    parallel: 'Up to 16 units (192 kW)',
  },
  {
    id: 'ruixu-sunon12',
    brand: 'RUiXU',
    model: 'SUNON12',
    name: 'SUNON12 12kW Off-Grid',
    kw: 12,
    pvInputKw: 24,
    battVoltage: '48V',
    mpptChannels: 2,
    ...
    warranty: '3 yr',
    price: null,
    image: '/inverters/ruixu-sunon12.png',
    tags: ['offgrid', 'ruixu', 'split-phase'],
    datasheet: '/datasheets/ruixu-sunon12.pdf',
    certifications: 'UL1741',
  ...
  },
  {
    ...
    brand: 'SolarEdge',
    model: 'SE7600H-USSMBBL14',
    name: 'SE7600H 7.6kW Energy Hub String Inverter',
    kw: 7.6,
    pvInputKw: 15.2,
  ...
  },
  {
    ...
    warranty: '12 yr',
    price: 1950,
    image: '/inverters/tigo-tsi-3-8k-us.jpg',
    tags: ['hybrid', 'tigo', 'single-phase'],
    certifications: 'UL1741 · NEC 690.12 · Built-in Wi-Fi',
    parallel: 'Up to 3 units (11.4 kW)',
  },
  {
    id: 'tigo-tsi-7-6k-us',
    brand: 'Tigo',
    model: 'TSI-7.6K-US',
    name: 'TSI-7.6K-US 7.6kW Hybrid',
    kw: 7.6,
    pvInputKw: 15.2,
    battVoltage: '48V',
    mpptChannels: 3,
    ...
    warranty: '12 yr',
    price: 2400,
    image: '/inverters/tigo-tsi-7-6k-us.jpg',
    tags: ['hybrid', 'tigo', 'single-phase'],
    certifications: 'UL1741 · NEC 690.12 · Built-in Wi-Fi',
    parallel: 'Up to 3 units (22.8 kW)',
  },
  {
    id: 'ecoflow-delta-pro-ultra-x-inverter',
    brand: 'EcoFlow',
    model: 'DELTA Pro Ultra X Inverter',
    name: 'DELTA Pro Ultra X 12kW Inverter',
    kw: 12,
    pvInputKw: 10,
    battVoltage: '—',
    mpptChannels: 0,
    ...
    warranty: '5 yr',
    price: 3799,
    image: '/inverters/ecoflow-delta-pro-ultra-x-inverter.png',
    tags: ['offgrid', 'ecoflow', 'split-phase'],
    certifications: 'Online UPS · 10ms transfer',
    parallel: 'Up to 3 units (36 kW)',
    flag: 'Pre-order',
  },
  {
    id: 'ecoflow-delta-pro-ultra-inverter',
    brand: 'EcoFlow',
    model: 'DELTA Pro Ultra Inverter',
    name: 'DELTA Pro Ultra 7.2kW Inverter',
    kw: 7.2,
    pvInputKw: 5.6,
    battVoltage: '—',
    mpptChannels: 0,
    outputVoltage: '120/240V',
    phase: 'Split-phase',
    dims: '27.2×18.9×8.42 in',
    weight: '—',
    type: 'offgrid',
    use: 'res',
    warranty: '5 yr',
    price: 2799,
    image: '/inverters/ecoflow-delta-pro-ultra-inverter.png',
    tags: ['offgrid', 'ecoflow', 'split-phase'],
    certifications: 'Online UPS · 0ms transfer',
    parallel: 'Up to 3 units (21.6 kW)',
    flag: 'Pre-order',
  },
  {
    id: 'enphase-iq8mc',
...
function Drawer({
  ...
  const emailMsg = useMemo(() => {
    if (!items.length) return '';
    const lines = items.map(p => `• ${p.brand} ${p.model} (${p.kw}kW, ${p.phase})${p.price ? ` — $${p.price.toLocaleString()}/unit` : ' — pricing TBD'}`);
    const body = encodeURIComponent(`Hi Brightify,\n\nI'd like a quote on these inverters:\n\n${lines.join('\n')}\n\nThank you.`);
    const subject = encodeURIComponent('Quote request — Inverters');
